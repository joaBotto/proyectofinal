...
export default function Successful ({setShowSuccessModal}) {
    ...
    return (
        ...
        <div className="relative bg-white p-8 rounded-lg shadow-lg w-96">
          <h2 className="text-xl font-semibold mb-4 text-gray-700 text-center"> ¡ Successful registration !</h2>
          <p className="text-gray-700 text-lg mb-4 text-center">welcome to an amazing page</p>
