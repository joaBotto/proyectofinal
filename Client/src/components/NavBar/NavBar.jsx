    ...
    <div className="text-white mb-10">
      ...
      >
        ...
        <div className="absolute top-10 right-10 mt-4 space-x-4 flex items-center">
          ...
          <Link to="/create">
            <a className="font-onest font-black text-blue hover:text-white hover:no-underline mr-10 pr-10">
          ...
          {user && user.name ? (
            <>
              <button
                className="pt-2 pb-2 pr-10 pl-10 text-white bg-violet rounded-full mr-10"
                onClick={toggleMenu}
              >
